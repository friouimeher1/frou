...
<form   action="{{route('admin.storereply',$user->id)}}" method="post">
  {{csrf_field()}}

										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-recipient">Administrateur:</label>

											<div class="col-sm-9">
												<span class="input-icon">
													<input type="email"  id="form-field-recipient" value="{{$admin->email}}"  placeholder="Email" name="email_admin" />
